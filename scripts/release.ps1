...
# Usage: .\scripts\release.ps1 -Version "0.2.0" [-Preview]
...
$tomlFiles = @(
    "crates/rouxflow-core/Cargo.toml",
    "crates/rouxflow-wasm/Cargo.toml",
    "crates/rouxflow-storage/Cargo.toml",
    "crates/rouxflow-render/Cargo.toml",
    "crates/rouxflow-bluetoothcube/Cargo.toml"
)
