...
fn face_r() {
    let mut cube = BitCube::new_solved();
    cube.apply_face_move(FaceMove::R);
    let grid = get_cube_grid(&cube);
    #[rustfmt::skip]
    let expected = [
        [" ", " ", " ", "W", "W", "G", " ", " ", " ", " ", " ", " "],
...
fn face_r_prime() {
    let mut cube = BitCube::new_solved();
    cube.apply_face_move(FaceMove::Rp);
    let grid = get_cube_grid(&cube);
    #[rustfmt::skip]
    let expected = [
        [" ", " ", " ", "W", "W", "B", " ", " ", " ", " ", " ", " "],
...
fn face_r2() {
    let mut cube = BitCube::new_solved();
    cube.apply_face_move(FaceMove::R2);
    let grid = get_cube_grid(&cube);
    #[rustfmt::skip]
    let expected = [
        [" ", " ", " ", "W", "W", "Y", " ", " ", " ", " ", " ", " "],
...
fn face_f() {
    let mut cube = BitCube::new_solved();
    cube.apply_face_move(FaceMove::F);
    let grid = get_cube_grid(&cube);
    #[rustfmt::skip]
    let expected = [
        [" ", " ", " ", "W", "W", "W", " ", " ", " ", " ", " ", " "],
...
fn face_f_prime() {
    let mut cube = BitCube::new_solved();
    cube.apply_face_move(FaceMove::Fp);
    let grid = get_cube_grid(&cube);
    #[rustfmt::skip]
    let expected = [
        [" ", " ", " ", "W", "W", "W", " ", " ", " ", " ", " ", " "],
...
fn face_f2() {
    let mut cube = BitCube::new_solved();
    cube.apply_face_move(FaceMove::F2);
    let grid = get_cube_grid(&cube);
    #[rustfmt::skip]
    let expected = [
        [" ", " ", " ", "W", "W", "W", " ", " ", " ", " ", " ", " "],
...
fn face_b() {
    let mut cube = BitCube::new_solved();
    cube.apply_face_move(FaceMove::B);
    let grid = get_cube_grid(&cube);
    #[rustfmt::skip]
    let expected = [
        [" ", " ", " ", "R", "R", "R", " ", " ", " ", " ", " ", " "],
...
fn face_b_prime() {
    let mut cube = BitCube::new_solved();
    cube.apply_face_move(FaceMove::Bp);
    let grid = get_cube_grid(&cube);
    #[rustfmt::skip]
    let expected = [
        [" ", " ", " ", "O", "O", "O", " ", " ", " ", " ", " ", " "],
...
fn face_b2() {
    let mut cube = BitCube::new_solved();
    cube.apply_face_move(FaceMove::B2);
    let grid = get_cube_grid(&cube);
    #[rustfmt::skip]
    let expected = [
        [" ", " ", " ", "Y", "Y", "Y", " ", " ", " ", " ", " ", " "],
